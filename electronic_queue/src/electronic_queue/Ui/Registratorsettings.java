...
public void SetActivePanel(int index){
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Парольная защита");

        jLabel8.setText("Запрос пароля при:");

        checkbox1.setLabel("Настройка");

        checkbox2.setLabel("Выход");

        jButton5.setText("Смена пароля");
        ...
        jTabbedPane1.addTab("Оформление", jPanel1);

        jLabel9.setText("Текстовка до номера");
        ...
        jLabel10.setText("Текстовка после номера");
        ...
        jTabbedPane1.addTab("Текстовка чека", jPanel2);
